...
{name:'即梦',url:'https://jimeng.jianying.com/',desc:{en:'ByteDance AI image + video generation',zh:'字节跳动AI生图/视频,剪映生态'},cat:'绘画',icon:'💫'},
...
{name:'腾讯ARC',url:'https://arc.tencent.com/',desc:{en:'Tencent AI: portrait restore, cutout, face enhancement',zh:'腾讯AI人像修复,人像抠图,画质增强'},cat:'绘画',icon:'🔧'},
