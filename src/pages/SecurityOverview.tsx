  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.chart} style={{marginBottom:20}}>
        ...
        <p style={{color:'var(--text-secondary)',lineHeight:1.8,fontSize:14,marginBottom:12}}>{L('Cybersecurity is an AI vs AI arms race. Attackers use AI to generate phishing emails and malware; defenders use AI for real-time detection and response. Darktrace AI identifies ransomware in seconds and auto-isolates; CrowdStrike AI analyzes trillions of events daily. China\'s 360 Security Brain uses AI to analyze global APT attacks. Global AI security market projected to exceed $60B by 2028.','网络安全是一场AI对AI的军备竞赛。攻击者用AI生成钓鱼邮件和恶意代码，防御者用AI实时检测和响应。Darktrace的AI在数秒内识别勒索软件攻击并自动隔离；CrowdStrike的AI每天分析数万亿事件，将威胁检测时间从天缩短到分钟。中国360安全大脑用AI分析全球APT攻击，年均发现30+国家级黑客组织。全球AI安全市场预计2028年突破600亿美元。','網路安全是一場AI對AI的軍備競賽。攻擊者用AI生成釣魚郵件和惡意代碼，防禦者用AI即時檢測和響應。Darktrace的AI在數秒內識別勒索軟體攻擊並自動隔離；CrowdStrike的AI每天分析數兆事件。中國360安全大腦用AI分析全球APT攻擊。全球AI安全市場預計2028年突破600億美元。')}</p>
      </section>
      <section className={styles.chart} style={{marginBottom:20}}>
